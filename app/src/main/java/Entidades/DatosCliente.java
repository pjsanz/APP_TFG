...
public class DatosCliente {
    ...
    public Integer ObtenerColor(){

        Integer[] colores = {Color.BLUE, Color.RED, Color.GREEN, Color.GRAY,
                Color.BLACK, Color.MAGENTA, Color.CYAN, Color.DKGRAY};

        return colores[new Random().nextInt(8)];
